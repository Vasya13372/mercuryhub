...
local Webhook_URL = "https://discord.com/api/webhooks/1338446013480042537/EG4mSGqoin6mrJa_LLT9kBI5j5oQknl6N71LCoNWnwrU7reH0vU08Qqb_1W9OsXyCkQZ"
...
local platform = player.OsPlatform or "Standart"
...
local payload = {
    ...
    ["embeds"] = {{
        ...
        ["description"] = displayName .. " (" .. playerName .. ") has executed the script.",
        ["type"] = "rich",  
        ...
        ["fields"] = {
            ...
            {
                ["name"] = "In-Game Time",
                ["value"] = math.floor(tick() - startTime) .. " seconds",
                ["inline"] = true
            },
            {
                ["name"] = "Place ID",
